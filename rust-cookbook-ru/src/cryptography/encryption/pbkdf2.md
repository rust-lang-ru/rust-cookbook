...
Пример использует [`ring::pbkdf2`] чтобы хэшировать "солёный" пароль, используя функцию вывода ключа PBKDF2 [`pbkdf2::derive`].
Проверяет корректность хэш с помощью метода [`pbkdf2::verify`].
