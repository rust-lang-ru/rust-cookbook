...
Создает пользовательскую структуру `RGB` и реализует типаж `FromStr` для преобразования предоставленного шестнадцатеричного цветового кода в его цветовой RGB код.
