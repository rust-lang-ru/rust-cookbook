## Реализация типажа `FromStr` у пользовательской структуры `struct`

[![std-badge]][std] [![cat-text-processing-badge]][cat-text-processing]

Создаёт пользовательскую структуру `RGB` и реализует типаж `FromStr` для преобразования предоставленного шестнадцатеричного цветового кода в его цветовой RGB код.
